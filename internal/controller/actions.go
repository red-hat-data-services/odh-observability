...
const (
	...
	clusterLoggingNamespace    = "openshift-logging"
...
func deployClusterLogForwarder(
	...
	logReady, err := isClusterLogForwarderReady(ctx, c)
	if err != nil {
...
func isClusterLogForwarderReady(ctx context.Context, c client.Client) (bool, error) {
